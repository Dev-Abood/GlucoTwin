...
export default function Dashboard({
  ...
  const getLatestReading = (type: ReadingType): GlucoseReading | null => {
    const filteredReadings = patientData.readings.filter(
      (r) => r.type === type
    );
                  ...
                  <section>
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Your glucose readings for the past 7 days
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-1">
                              <p className="text-sm font-medium leading-none">
                                Upcoming appointment with Dr. Abdulla
                              </p>
                              <p className="text-sm text-muted-foreground">
                                Next appointment in 4 days
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <TabsContent value="recommendations" className="space-y-4">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Based on your recent glucose readings and upcoming appointments
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        <div className="rounded-lg border p-4">
                          <h3 className="font-medium">Diet Suggestions</h3>
                          <p className="text-sm text-muted-foreground mt-2">
                            Your after-dinner readings are slightly elevated.
                            Consider reducing carbohydrate intake in the evening
                            and adding more fiber-rich vegetables to your
                            dinner.
                          </p>
                        </div>
                        <div className="rounded-lg border p-4">
                          ...
                          <p className="text-sm text-muted-foreground mt-2">
                            A 15-minute walk after meals can help lower
                            post-meal glucose levels. Try to incorporate light
                        ...
                        <div className="rounded-lg border p-4">
                          ...
                          <p className="text-sm text-muted-foreground mt-2">
                            Continue with your current testing schedule before
                            and after each meal. This provides valuable data for
