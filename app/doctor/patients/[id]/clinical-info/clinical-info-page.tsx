...
export default function ClinicalInfoPage({
  ...
  const [weight, setWeight] = useState<string>(
    clinicalInfo?.weight?.toString() ?? ""
  );
  const [height, setHeight] = useState<string>(
    clinicalInfo?.height?.toString() ?? ""
  );
  const [computedBmi, setComputedBmi] = useState<string>(
    clinicalInfo?.bmi?.toFixed(1) ?? ""
  );
  ...
  const mapFeaturesToDisplayNames = (features: string[]): string[] => {
    return features.map(
      (feature) => FEATURE_DISPLAY_MAPPING[feature] || feature
    );
  };
  ...
  const getPredictionMessage = (prediction?: GDMPrediction) => {
    ...
    return (
      messages[prediction.riskCategory] ||
      "Unable to generate prediction message."
    );
  };
  ...
  const validateForm = (fd: FormData) => {
    const requiredFields: Array<{
      ...
      { name: "height", label: "Height", type: "number", inputId: "height" },
      {
        ...
        type: "number",
        inputId: "weightGainDuringPregnancy",
      },
      {
        name: "fastingBloodGlucose",
        label: "Fasting Blood Glucose",
        type: "number",
        inputId: "fastingBloodGlucose",
      },
      {
        name: "oneHour75Glucose",
        label: "1 Hour (75g Glucose)",
        type: "number",
        inputId: "oneHour75Glucose",
      },
      {
        name: "twoHour75Glucose",
        label: "2 Hour (75g Glucose)",
        type: "number",
        inputId: "twoHour75Glucose",
      },
      {
      ...
      if (isInvalid) {
        ...
        if (field.inputId) {
          ...
          const trigger = formRef.current
            ?.querySelector<HTMLElement>(`[name="${field.name}"]`)
    ...
    if (!computedBmi) {
      ...
      if (!firstInvalidElement)
        firstInvalidElement = (wEl || hEl) as HTMLElement | null;
    }
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to reset clinical information",
        variant: "destructive",
      });
    } finally {
  ...
  // Form submit handler
  const onSubmitValidateThenSave: React.FormEventHandler<
    HTMLFormElement
  > = async (e) => {
    e.preventDefault();
    if (!formRef.current) return;
            ...
            <div className="mb-6 flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Manage clinical data for {patient.name} (ID:{" "}
                  {patient.patientId})
                </p>
              </div>
            </div>
              ...
              <div className="grid gap-6">
                  ...
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Select
                        name="nationality"
                        defaultValue={
                          clinicalInfo?.nationality ?? "not_specified"
                        }
                      >
                        <SelectTrigger>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Body measurements and pregnancy-related metrics
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="weightGainDuringPregnancy">
                      ...
                      <Input
                        ...
                        defaultValue={
                          clinicalInfo?.weightGainDuringPregnancy?.toString() ??
                          ""
                        }
                      />
                    </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Glucose tolerance test results and lab measurements
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 md:grid-cols-3">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={
                          clinicalInfo?.fastingBloodGlucose?.toString() ?? ""
                        }
                      />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="oneHour75Glucose">
                        1 Hour (75g Glucose) (mg/dL)
                      </Label>
                      <Input
                        id="oneHour75Glucose"
                        name="oneHour75Glucose"
                        ...
                        defaultValue={
                          clinicalInfo?.oneHour75Glucose?.toString() ?? ""
                        }
                      />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="twoHour75Glucose">
                        2 Hour (75g Glucose) (mg/dL)
                      </Label>
                      <Input
                        id="twoHour75Glucose"
                        name="twoHour75Glucose"
                        ...
                        defaultValue={
                          clinicalInfo?.twoHour75Glucose?.toString() ?? ""
                        }
                      />
                    </div>
                  </CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Medical conditions and vital sign measurements
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <Label htmlFor="hypertensiveDisorders">
                        Hypertensive Disorders
                      </Label>
                      <Select
                        name="hypertensiveDisorders"
                        defaultValue={
                          clinicalInfo?.hypertensiveDisorders ?? "No"
                        }
                      >
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={
                          clinicalInfo?.pulseHeartRate?.toString() ?? ""
                        }
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={
                          clinicalInfo?.bpSystolic?.toString() ?? ""
                        }
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={
                          clinicalInfo?.bpDiastolic?.toString() ?? ""
                        }
                      />
                    </div>
                  </CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Machine learning prediction for gestational diabetes
                      mellitus risk
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    {latestPrediction ? (
                      <div className="space-y-4">
                        ...
                        {latestPrediction.topInfluentialFeatures &&
                          latestPrediction.topInfluentialFeatures.length >
                            0 && (
                            <div className="space-y-2">
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                          Complete and save the clinical information above to
                          generate an AI risk assessment for gestational
                          diabetes mellitus.
                        </p>
                        <Badge variant="outline">
                          Prediction will be generated on save
                        </Badge>
                      </div>
                    )}
                  </CardContent>
                  ...
                  {clinicalInfo && (
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle>
                            Delete all clinical info?
                          </AlertDialogTitle>
                          <AlertDialogDescription>
                            This action will permanently delete all clinical
                            information and AI predictions for this patient.
